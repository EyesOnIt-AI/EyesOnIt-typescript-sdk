export class EOIEffects {
    constructor(
        ...
        public show_bounding_box_labels: boolean,
        ...
        public blur_non_validated_detections: boolean,
        public show_confidence_levels: boolean,
        public show_velocity: boolean,
    ...
    public static fromJsonObj(obj: any) {
        ...
        if (obj != null) {
            effects = new EOIEffects(
                ...
                obj.show_bounding_box_labels,
                obj.show_lines,
                obj.show_regions,
                obj.show_preliminary_detections,
                obj.show_validated_detections,
                obj.blur_non_validated_detections,
